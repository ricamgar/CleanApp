...
import com.ricamgar.citibox.DaggerTestCitiboxComponent
import com.ricamgar.citibox.R
import com.ricamgar.citibox.TestCitiboxApp
...
class PostsListActivityTest {
    ...
    fun setUp() {
        ...
        val app = instrumentation.targetContext.applicationContext as TestCitiboxApp

        DaggerTestCitiboxComponent
            .builder()
            .application(app)
